...
namespace DALEfDB
{
    ...
    {
        public const string ConnectionString = @"Data Source=DESKTOP-IL8B3HF\SQLEXPRESS;Initial Catalog=GamerShop;Integrated Security=True;Pooling=False;TrustServerCertificate=true;";

...
namespace DALEfDB.Migrations
{
    ...
    [Migration("20230925134818_AddFilmAdaptations")]
    partial class AddFilmAdaptations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DALInterfaces.Models.Books.Book", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DALInterfaces.Models.Movies.Movie", b =>
                {
                    ...
                    b.Property<int?>("FilmAdaptationOfId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DALInterfaces.Models.Movies.Movie", b =>
                {
                    b.HasOne("DALInterfaces.Models.Books.Book", "FilmAdaptationOf")
                        .WithMany("FilmAdaptations")
                        .HasForeignKey("FilmAdaptationOfId");

                    b.Navigation("FilmAdaptationOf");
                });

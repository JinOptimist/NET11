...
using FootballClubRepository = DALWrongDB.Repositories.FootballClubRepository;
using MovieRepository = DALWrongDB.Repositories.MovieRepository;
...
//uilder.Services.AddSingleton<IHeroRepository,BgRepository>();
